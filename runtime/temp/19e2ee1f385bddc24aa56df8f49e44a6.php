<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:77:"C:\phpstudy_pro\WWW\public/../application/admin\view\business\goods\edit.html";i:1591005949;s:62:"C:\phpstudy_pro\WWW\application\admin\view\layout\default.html";i:1588765311;s:59:"C:\phpstudy_pro\WWW\application\admin\view\common\meta.html";i:1588765311;s:61:"C:\phpstudy_pro\WWW\application\admin\view\common\script.html";i:1588765311;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-business_id" data-rule="required"  data-source="business/business/index" class="form-control selectpage" name="row[business_id]" type="text" value="<?php echo htmlentities($row['business_id']); ?>">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-category_id"  data-field="title"  data-multiple ="true"   data-rule="required" data-source="business/Goods_Category/index" class="form-control selectpage" name="row[category_id]" type="text" value="<?php echo $row['category_id']; ?>">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-original_price" data-rule="required" class="form-control" step="0.01" name="row[original_price]" type="number" value="<?php echo htmlentities($row['original_price']); ?>">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-desc" data-rule="required" class="form-control" name="row[desc]" type="text" value="<?php echo htmlentities($row['desc']); ?>">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-stock" data-rule="required" class="form-control" name="row[stock]" type="text" value="<?php echo htmlentities($row['stock']); ?>">
        </div>
    </div>

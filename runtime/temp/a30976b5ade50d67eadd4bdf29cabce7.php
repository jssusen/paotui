<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:79:"C:\phpstudy_pro\WWW\public/../application/admin\view\business\business\add.html";i:1591005208;s:62:"C:\phpstudy_pro\WWW\application\admin\view\layout\default.html";i:1588765311;s:59:"C:\phpstudy_pro\WWW\application\admin\view\common\meta.html";i:1588765311;s:61:"C:\phpstudy_pro\WWW\application\admin\view\common\script.html";i:1588765311;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-school_id" data-rule="required" data-source="university/school/index" class="form-control selectpage" name="row[school_id]" type="text" value="">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-synopsis" data-rule="" class="form-control "  name="row[synopsis]" >
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-mini_price" data-rule="required" class="form-control" step="0.01" name="row[mini_price]" type="number" value="0.00">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Packing_fee'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-packing_fee" data-rule="required" class="form-control" step="0.01" name="row[packing_fee]" type="number" value="0.00">
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <input id="c-service_time" data-rule="required" class="form-control" name="row[service_time]" type="number" placeholder="单位分钟">

            <!--            <input id="c-service_time" data-rule="required" class="form-control datetimepicker" data-date-format="YYYY-MM-DD HH:mm:ss" data-use-current="true" name="row[service_time]" type="text" value="<?php echo date('Y-m-d H:i:s'); ?>">-->
        </div>
    </div>
    <div class="form-group">

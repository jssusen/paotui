<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:80:"C:\phpstudy_pro\WWW\public/../application/admin\view\business\business\edit.html";i:1591005293;s:62:"C:\phpstudy_pro\WWW\application\admin\view\layout\default.html";i:1588765311;s:59:"C:\phpstudy_pro\WWW\application\admin\view\common\meta.html";i:1588765311;s:61:"C:\phpstudy_pro\WWW\application\admin\view\common\script.html";i:1588765311;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-school_id" data-rule="required" data-source="university/school/index" class="form-control selectpage" name="row[school_id]" type="text" value="<?php echo htmlentities($row['school_id']); ?>">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-synopsis" data-rule="" class="form-control "  name="row[synopsis]"  value="<?php echo htmlentities($row['synopsis']); ?>">
        </div>
    </div>
    ...
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Mini_price'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-mini_price" data-rule="required" class="form-control" step="0.01" name="row[mini_price]" type="number" value="<?php echo htmlentities($row['mini_price']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Packing_fee'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-packing_fee" data-rule="required" class="form-control" step="0.01" name="row[packing_fee]" type="number" value="<?php echo htmlentities($row['packing_fee']); ?>">
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <input id="c-service_time" data-rule="required" class="form-control" name="row[service_time]" type="number" placeholder="单位分钟"  value="<?php echo $row['service_time']; ?>" >
<!--            <input id="c-service_time" data-rule="required" class="form-control datetimepicker" data-date-format="YYYY-MM-DD HH:mm:ss" data-use-current="true" name="row[service_time]" type="text" value="<?php echo $row['service_time']?datetime($row['service_time']):''; ?>">-->
        </div>
    </div>
    <div class="form-group">
